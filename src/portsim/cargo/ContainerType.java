...
{
    /** Open top shipping containers have the goods are loaded in through the top by crane or other top loading machinery. */
    OPEN_TOP,

    /** Another form of shipping container that does not fit into other categories. */
    OTHER,

    /** Reefer containers are big fridges that are used to transport temperature controlled cargoes such as fruits, meat, fish, seafood. */
    REEFER,
