...
/** Exception thrown when a ship is requested by a given IMO number but no ship with that
 * IMO number exists
 * See {@link  Ship.getShipByImoNumber(long).}
 * */
public class NoSuchShipException extends Exception {
    ...
    /** Constructs a NoSuchShipException that contains a helpful detail message explaining
